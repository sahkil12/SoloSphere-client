...
*Frontend*: React, React Router, Firebase Hosting, Firebase Authentication, axios, tanstack query . 
*Backend*: , Mongodb Realtime Database, jsonwebtoken for cookies . 
*Styling*: CSS, tailwind, daisyui, Meraki Ui.
