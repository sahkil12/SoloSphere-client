    ...
    return (
        <section className='container px-4 mx-auto py-12'>
            <div className='flex items-center gap-x-3'>
                <h2 className='text-lg font-bold text-gray-800 '>Bid Requests</h2>
                                            ...
                                            <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                                <div className='flex items-center gap-x-2'>
                                                    <p
                                                        ...
                                                        ${bid.category === 'Web Development' && 'text-blue-500 bg-blue-100/75'}  
                                            ...
                                            <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                                <div className='flex items-center gap-x-6'>
                                                    ...
                                                    <button
                                                        ...
                                                        className='text-gray-500 transition-colors duration-200   hover:text-green-400 focus:outline-none'>
                                                        <svg
