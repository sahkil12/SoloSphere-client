...
const Jobs = () => {
    ...
    useEffect(() => {
        fetch(`${import.meta.env.VITE_API_URL}/all-jobs?page=${currentPage}&size=${itemsPerPage}&filter=${filter}&sort=${sort}&search=${search}`)
            .then(res => res.json())
            .then(data => {
                setJobs(data)
            })
    ...
    useEffect(() => {
        fetch(`${import.meta.env.VITE_API_URL}/jobs-count?&filter=${filter}&search=${search}`)
            .then(res => res.json())
            .then(data => {
                setCount(data.count)
            })
